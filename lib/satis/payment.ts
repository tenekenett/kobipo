 ...
 *
 * Yazım kuralları (virgül/nokta, binlik ayracı) `parseTrNumber` içinde —
 * [[lib/format.ts]]. Buradaki ek POLİTİKA ödeme kutusuna özgü: negatif ve
 * okunamayan giriş 0'dır, çünkü eksi tahsilatın ya da "abc" TL'nin anlamı yok.
 * Filtre kutusu aynı politikayı KULLANAMAZ (orada "0" gerçek bir alt sınır,
 * "abc" ise hatadır) — o yüzden ayrıştırma politikasız katmanda duruyor.
 */
